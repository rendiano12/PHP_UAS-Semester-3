...
<body>
    ...
    <main>
        <div class="content">
            <h1>Mengedit Data Buku</h1><br><br>
                ...
                <form method="post" action="edit.php">                    
                    ...
                    <table>                 
                        <tr>
                            <td>Judul Buku</td>
                            <td>:</td>
                            <td><input type="text" value="<?php echo $d['judul']; ?>" name="judul" autocomplete="off" required></td>
                        </tr>
                        <tr>
                            <td>Pengarang</td>
                            <td>:</td>
                            <td><input type="text" value="<?php echo $d['pengarang']; ?>" name="pengarang" autocomplete="off" required></td>
                        </tr>
                        <tr>
                            <td>Genre</td>
                            <td>:</td>
                            <td><input type="text" value="<?php echo $d['genre']; ?>" name="genre" autocomplete="off" required></td>
                        </tr>
                        <tr>
                            <td>Harga</td>
                            <td>:</td>
                            <td><input type="number" value="<?php echo $d['harga']; ?>" name="harga" autocomplete="off" required></td>
                        </tr>
                        <tr>
                            <td>Cover</td>
                            <td>:</td>
                            <td><input type="file" value="<?php echo $d['cover']; ?>" name="cover" autocomplete="on" required></td>
                        </tr>
                        <tr>
                            <td></td>
                            <td></td>
                            <td><br><input type="submit" value="Simpan" name="simpan"></td>
                        </tr>           
                    </table>              
                </form>
            </fieldset>
